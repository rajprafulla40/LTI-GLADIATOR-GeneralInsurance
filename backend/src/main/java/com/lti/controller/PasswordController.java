...
import com.lti.data.ForgotDto;
import com.lti.data.ForgotPasswordStatus;
import com.lti.data.OtpDto;
import com.lti.data.StatusDto;
import com.lti.data.StatusDto.StatusType;
import com.lti.data.UpdateDto;
import com.lti.entity.User;
import com.lti.exceptions.UserServiceException;
...
public class PasswordController {
	...
	public ForgotPasswordStatus forgotPassword(@RequestBody ForgotDto forgotDto) {
		...
		try {
			...
			passwordResetEmail.setFrom("jid.falak30@gmail.com"); // email of sender
