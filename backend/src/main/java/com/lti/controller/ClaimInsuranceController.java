...
import com.lti.data.ApproveClaimDto;
import com.lti.data.ClaimDto;
import com.lti.data.GetAllClaims;
import com.lti.entity.Claim;
import com.lti.entity.Customer;
import com.lti.entity.Policy;
import com.lti.exceptions.InsuranceServiceException;
...
//	@GetMapping(path="/getClaim/{id}" )
//	public Claim getClaimsHistory(@PathVariable("id") int id ) {
//		return service.getClaimDataById(id);
//		
//	}
